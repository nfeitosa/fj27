 ...
 *
 */
public class SimpleHaviGui2 implements Xlet, KeyListener {
	
	private XletContext context;
	private HScene hscene;
	HTextButton htextButton;	
	
	public SimpleHaviGui2() {
	...
	public void startXlet() throws XletStateChangeException {
		...
		/************************************************
		 * Código adicionado para tratamento de eventos
		 ************************************************/
	...
	public void keyPressed( KeyEvent event ) {
		...
		if ( keyCode == 403 ){			
			htextButton.setTextContent( "Botão vermelho clicado!", HState.ALL_STATES );
			htextButton.repaint();			
		}
